...
CK = 'Type you key here.'  # Consumer Key
CS = 'Type you key here.'  # Consumer Secret
AT = 'Type you key here.'  # Access Token
AS = 'Type you key here.'  # Accesss Token Secert
...
if __name__ == '__main__':
    ...
    # キーワードで取得
    # getter = TweetsGetter.bySearch(u'検索したいキーワード')

    # ユーザーを指定して取得 （screen_name）
    getter = TweetsGetter.byUser('検索したいユーザー名@マーク以降を入力する')
    ...
    #csv出力
    with open('nakanishi.csv', 'w', newline='', encoding='utf-8') as f:
